...
import writeDown from "@/views/hirunner/case/WriteDown";
...
export default {
  ...
  methods: {
    ...
    getCaseList() {
      ...
      this.$http
        .get("/hirunner/cases", { params: filterNullValue(params) })
    ...
    onCopy(id = "") {
      ...
      this.$http
        .post(`/hirunner/cases/${id}/copy`, params)
        .then(() => {})
        .finally(() => {
